...
create database Dalvi_University 
use Dalvi_University;
...
create table dapartment_table(
Department_id int,
Dapartment_name varchar(50),
Dapartment_facility varchar(50)
);

select * from dapartment_table
